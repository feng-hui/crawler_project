...
from medicalmap.utils.common import now_day, custom_remove_tags, get_county2, match_special2
...
class Nj12320Spider(scrapy.Spider):
    ...
    headers = {
        ...
        'Referer': 'http://www.nj12320.org/njres/',
    ...
    search_hos_url = 'http://www.nj12320.org/njres/reservation/hos_search.do'
