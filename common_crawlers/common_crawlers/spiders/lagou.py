...
class LagouSpider(CrawlSpider):
    ...
    start_urls = ['https://www.lagou.com/zhaopin/PHP/?labelWords=label']
    ...
    def parse_item(self, response):
        ...
        loader.add_xpath('job_tags', '//ul[@class="position-label"]/li/text()')
        ...
        loader.add_xpath('job_comp_url', '//ul[@class="c_feature"]/li[4]/a/@href')
        loader.add_xpath('job_comp_name', '//h2[@class="fl"]/text()')
        loader.add_value('crawl_time', now_time())
        loader.add_value('crawl_update_tim ', now_time())
