...
class CsvToDict(object):
    ...
    def read_file(self, size=None, use_cols=None):
        ...
        file_path = os.path.join('/home/fengh/wksp/crawler_project/'
                                 'haodaifu/haodaifu/my_data', self.file_name)
...
if __name__ == "__main__":
    excel_to_dict = CsvToDict('haodf_0810_2.csv')
    my_data = excel_to_dict.read_file(use_cols=['doctor_hid'])
