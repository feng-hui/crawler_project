...
class F139HbFl(F139Price):
    job_name = '富宝报价抓取——河北地区废铝价格'
    data_url = "http://data.f139.com/list.do?pid=&vid=17&qw=3:31"
    title = '{}{}'.format(f139_config.prefix_of_title, "河北地区废铝价格")
