...
class F139ShFt(F139Price):
    job_name = '富宝报价抓取——上海地区废铜价格'
    data_url = 'http://data.f139.com/list.do?pid=&vid=16&qw=3:258'
    title = '{}{}'.format(f139_config.prefix_of_title, "上海地区废铜价格")
            ...
            if text_flat and text_flat != ['\r\n\t\t\t\t\t\t\t', '\r\n\t\t\t\t\t']:
                ...
                if text_rise:
                    ...
                    if text_fall:
                        ...
                        fifth_column.append('')
        # 整合表格
        first_column = first_column[0:4] + first_column[6:11] + [first_column[4]]
        second_column = second_column[0:4] + second_column[6:11] + [second_column[4]]
        third_column = third_column[0:4] + third_column[6:11] + [third_column[4]]
        fourth_column = fourth_column[0:4] + fourth_column[6:11] + [fourth_column[4]]
        fifth_column = fifth_column[0:4] + fifth_column[6:11] + [fifth_column[4]]
