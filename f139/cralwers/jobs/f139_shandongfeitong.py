...
__author__ = 'Feng_hui'
__time__ = '2018/2/9 14:22'


class F139SdFt(F139Price):
    job_name = '富宝报价抓取——山东地区废铜价格'
    data_url = 'http://data.f139.com/list.do?pid=&vid=16&qw=3:43'
    title = '{}{}'.format(f139_config.prefix_of_title, "山东地区废铜价格")
