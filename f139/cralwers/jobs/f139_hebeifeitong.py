...
__author__ = 'Feng_hui'
__time__ = '2018/2/9 15:21'


class F139HbFt(F139Price):
    job_name = '富宝报价抓取——河北地区废铜价格'
    data_url = 'http://data.f139.com/list.do?pid=&vid=16&qw=3:31'
    title = '{}{}'.format(f139_config.prefix_of_title, "河北地区废铜价格")
            ...
            if text_flat and text_flat != ['\r\n\t\t\t\t\t\t\t', '\r\n\t\t\t\t\t']:
                ...
                if text_rise:
                    ...
                    if text_fall:
                        ...
                        fifth_column.append('')
        # 整合表格
        first_column = first_column[0:3] + first_column[6:10] + first_column[3:5]
        second_column = second_column[0:3] + second_column[6:10] + second_column[3:5]
        third_column = third_column[0:3] + third_column[6:10] + third_column[3:5]
        fourth_column = fourth_column[0:3] + fourth_column[6:10] + fourth_column[3:5]
        fifth_column = fifth_column[0:3] + fifth_column[6:10] + fifth_column[3:5]
