...
__author__ = 'Feng_hui'
__time__ = '2018/2/28 9:06'


class F139SdFl(F139Price):
    job_name = '富宝报价抓取——山东地区废铝价格'
    data_url = "http://data.f139.com/list.do?pid=&vid=17&qw=3:43"
    title = '{}{}'.format(f139_config.prefix_of_title, "山东地区废铝价格")
            ...
            if text_flat and text_flat != ['\r\n\t\t\t\t\t\t\t', '\r\n\t\t\t\t\t']:
                ...
                if text_rise:
                    ...
                    if text_fall:
                        ...
                        fifth_column.append('')
        # 整合表格
        table = zip(first_column, third_column, fourth_column, fifth_column)
        single_tr = []
